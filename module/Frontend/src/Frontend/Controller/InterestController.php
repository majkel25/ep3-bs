...
class InterestController extends AbstractActionController
{
    ...
    public function registerAction()
    {
        try {
            ...
            /**
             * 3) Extract user ID (matches how UserSessionManager uses the entity)
             */
            $userId = null;
            ...
            /**
             * 8) Instantiate BookingInterestService
             *    (autoload should pick this up via Service\Module autoloader)
             */
            try {
